...
</div>`,me=document.getElementById("exerciseSection"),ge=document.getElementById("categoriesSection");function fe(){if(!F)return;F.insertAdjacentHTML("afterbegin",`${de}${ue}`),Y(n.get("filter")||"Muscles");const e={form:document.querySelector(".search-form"),title:document.querySelector(".exercises-title"),list:document.querySelector(".category-list_buttons"),categoryButtons:document.querySelectorAll(".category-button"),input:document.querySelector(".form-input"),searchButton:document.querySelector(".search-button")},{list:t,searchButton:s,form:i}=e;e.input.addEventListener("input",ve),s.addEventListener("click",he),t.addEventListener("click",ye),i.addEventListener("submit",be)}function ve(e){if(!e.target.value)return;const t={searchIcon:document.querySelector(".search-icon"),closeIcon:document.querySelector(".close-icon")};u(t.searchIcon),g(t.closeIcon)}function Y(e){const t=document.querySelectorAll(".category-button");Array.prototype.forEach.call(t,i=>i.classList.remove("active"));const s=Array.prototype.find.call(t,i=>i.dataset.filter===e);s==null||s.classList.add("active"),n.set("filter",e)}function pe(e){const t=e[0].toUpperCase()+e.slice(1),s=document.querySelector(".exercises-title");s.innerHTML=`Exersise / <span class="subtitle">${t}</span>`}function he(){const e=document.querySelector(".form-input"),t=document.querySelector(".close-icon"),s=document.querySelector(".search-icon");e.value="",t.classList.add("visually-hidden"),s.classList.remove("visually-hidden")}function ye(e){const t=e.target.dataset.filter,s=document.querySelector(".exercises-title");s.innerHTML="Exersise",Y(t),n.set("filter",t),U(),g(ge),u(me),u(document.querySelector(".search-form"))}function xe(){const e=document.querySelector(".search-form");e==null||e.classList.add("visually-hidden")}function be(e){e.preventDefault();const s=document.querySelector(".form-input").value;n.set("keyword",s),Q(),e.target.reset();const i={searchIcon:document.querySelector(".search-icon"),closeIcon:document.querySelector(".close-icon")};g(i.searchIcon),u(i.closeIcon)}function Se(){const e=document.querySelectorAll(".header-nav-link");let t=!0;e.forEach(s=>{window.location.pathname.includes(s.dataset.page)&&(s.classList.add("active"),t=!1)}),t&&document.querySelectorAll(".header-nav-link[data-page='home']").forEach(i=>i.classList.add("active"))}function z(e,t,s="topRight",i=5e3){ee.show({message:e,color:t,position:s,timeout:i})}function m(e){z(e,"red")}function we(e){z(e,"green")}const qe=te({email:se().email().required()}),x="visually-hidden";function Le(e){e&&(e.style.animationPlayState="running",e.classList.remove(x))}function $e(e){e&&(e.style.animationPlayState="paused",e.classList.add(x))}const D=document.querySelector("#js-subscribe"),$=document.querySelector("#js-subscribe-spinner");async function Ee(e){e.preventDefault(),H(e.target);const t=new FormData(e.target);try{const s=await qe.validate({email:t.get("email")}),i=await ce(s);we(i.message)}catch(s){m(s.response.data.message)}finally{setTimeout(()=>{e.target.reset(),H(e.target)},500)}}function ke(e){e.classList.add(x)}function Me(e){e.classList.remove(x)}function H(e){if(!e)return;const t=e.children.subscribeBtn,s=t.children[0];if($.classList.contains(x)){t.disabled=!0,Le($),ke(s);return}$e($),Me(s),t.disabled=!1}function Ce(){D&&D.addEventListener("submit",Ee)}function Ie(){const e=document.querySelector(".scroll-up-button");function t(){window.scrollTo({top:0,behavior:"smooth"})}const s=ie(()=>{window.scrollY>=100?g(e):u(e)},500);window.addEventListener("scroll",s),e.addEventListener("click",t)}function je(){const e=document.querySelector(".modal-exercises"),t=document.querySelector(".overlay"),s=document.querySelector(".exercise-list");if(!e||!t||!s)return;let i=!1;s.addEventListener("click",o=>Te(o,e,t,i)),t.addEventListener("click",function(o){o.target===t&&E(e,t)}),document.addEventListener("keydown",function(o){o.key==="Escape"&&!e.classList.contains("visually-hidden")&&E(e,t)})}async function Te(e,t,s,i){if(e.target.closest(".js-start-btn"))try{const o=e.target.closest(".js-start-btn").getAttribute("data-id"),r=await N(o),a=De(r);Ae(a),i=(n.get("exerciseData")||[]).includes(o);const c=document.querySelector(".modal-exercises-btn-favorites");c.innerHTML=i?W():J(),c.dataset.toggle=i?"remove":"add",Be(t,s),c.addEventListener("click",d=>He(o,d.target.dataset.toggle)),document.querySelector(".modal-exercises-btn-close").addEventListener("click",()=>E(t,s))}catch{m("Information not found")}}function Be(e,t){e.classList.remove("visually-hidden"),t.classList.remove("visually-hidden"),document.body.classList.add("fixed")}function Ae(e){const t=document.querySelector(".modal-exercises");t&&(t.innerHTML=e)}function Fe(e){const t="#EEA10C",s="#F4F4F4",o=[];for(let a=0;a<5;a++){const c=a+1<=e?100:a<e?e%1*100:0,l=`
<svg width="14" height="13">
    ...
    `;o.push(l)}return`${Number.isInteger(e)?`${e}.0`:e.toFixed(1)} ${o.join("")}`}function De({_id:e,bodyPart:t,equipment:s,gifUrl:i,name:o,target:r,description:a,rating:c,burnedCalories:l,time:d,popularity:f}){const v=X(i);function X(q){return q===null||!q?`srcset = "./image/modal-coming-soon.jpg"
      src = "./image/modal-coming-soon.jpg"`:`src="${q}"`}const Z=Fe(c);return`
...
`}function J(){return`
  ...
  `}function He(e,t){if(t==="add"){const s=document.querySelector(".modal-exercises-btn-favorites");s.dataset.toggle="remove",s.innerHTML=W(),Pe(e)}else{const s=document.querySelector(".modal-exercises-btn-favorites");s.dataset.toggle="add",s.innerHTML=J(),Oe(e)}}async function Pe(e){try{if(!e){m("Invalid exerciseID");return}const t=n.get("exerciseData")||[];if(t.includes(e)){m("Already added");return}t.push(e),n.set("exerciseData",t)}catch{m("Error fetching or storing exercise data")}}async function Oe(e){try{if(!e){m("Invalid exerciseID");return}const t=(n.get("exerciseData")||[]).filter(s=>s!==e);n.set("exerciseData",t)}catch{m("Error removing exercise from favorites")}}function E(e,t){e.classList.add("visually-hidden"),t.classList.add("visually-hidden"),document.body.classList.remove("fixed")}const P="today",O="quote-of-the-day";async function _e(){const e=document.querySelector("#quoteContainer");if(!e)return;const t=!window.location.pathname.includes("favorites"),s=await Ne(),i=Ke(s.quote,s.author,t);e.insertAdjacentHTML("afterbegin",i)}async function Ne(){const e=n.get(P)??"";let t=n.get(O)??"";const s=Ge();if(e!==s||!t)try{t=await ae(),n.set(O,t),n.set(P,s)}catch(i){m(i.message)}return t}function Ge(){const e=new Date(Date.now()),t=e.getFullYear(),s=e.getMonth();return`${e.getDate()}/${s}/${t}`}function Ke(e,t,s){return`    <!-- quote -->
      ...
      </div>`}function Qe(){const e=document.querySelector(".favorites-title"),t=document.querySelector("#favcardsContainer");if(!e)return;Re();const s=n.get("exerciseData");let i=[];s?s.map(a=>{i.push(a),o(i)}):k(document.querySelector(".favorites-title"));async function o(a){const c=await Promise.all(a.map(l=>N(l)));r(c)}function r(a){t.innerHTML=a?R(a,!0):k(document.querySelector(".favorites-title"))}}function k(e){e.insertAdjacentHTML("beforeend",`<p class="favorites-noitemsmessage">It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future.</p>`)}function Re(){const e=document.querySelector(".favcards-container");e&&e.addEventListener("click",t=>{if(!t.target.classList.contains("exercise-card-removeIcon"))return;const s=t.target,i=s.closest(".exercise-card"),o=s.dataset.id;if(!o)return;let r=n.get("exerciseData")||[];r=r.filter(a=>a!==o),n.set("exerciseData",r),i==null||i.remove(),r.length||k(document.querySelector(".favorites-title"))})}function Ue(){fe(),oe(),Se(),Ce(),_e(),Ie(),je(),le(),U(),Qe()}Ue();
//# sourceMappingURL=main-f88b9f17.js.map
