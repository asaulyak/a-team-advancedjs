var E=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)};var M=(e,t,s)=>(E(e,t,"read from private field"),s?s.call(e):t.get(e)),L=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)};var x=(e,t,s)=>(E(e,t,"access private method"),s);import{a as h,P as W,i as X,c as Z,b as V,t as ee}from"./vendor-98b3cdf8.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=s(o);fetch(o.href,r)}})();function te(){const e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),s=document.querySelector(".js-close-menu"),i=document.querySelector("body"),o=a=>{(a.target.classList.contains("nav__link")||a.target.classList.contains("mobile-backdrop"))&&r()},r=()=>{const a=t.getAttribute("aria-expanded")==="true"||!1;t.setAttribute("aria-expanded",!a),e.classList.toggle("is-open"),i.classList.toggle("fixed")};t.addEventListener("click",r),e.addEventListener("click",o),s.addEventListener("click",a=>{r()}),window.matchMedia("(min-width: 768px)").addEventListener("change",a=>{a.matches&&(e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1))})}var S,f,w;class se{constructor(){L(this,f);L(this,S,"your-energy")}set(t,s){localStorage.setItem(x(this,f,w).call(this,t),JSON.stringify(s))}get(t){try{return JSON.parse(localStorage.getItem(x(this,f,w).call(this,t)))}catch{return null}}remove(t){localStorage.removeItem(x(this,f,w).call(this,t))}clear(){localStorage.clear()}}S=new WeakMap,f=new WeakSet,w=function(t){return`${M(this,S)}.${t}`};const n=new se,y="https://your-energy.b.goit.study/api";function O(e){const{page:t,perPage:s,totalPages:i}=e.data;return{...e.data,page:+t,perPage:+s,totalPages:i??0}}function j(e){const t=Object.keys(e).filter(s=>!!e[s]).map(s=>`${s}=${e[s]}`).join("&");return h.get(`${y}/exercises?${t}`).then(s=>O(s))}function ie(e){return h.get(`${y}/exercises/${e}`).then(t=>t.data)}function oe(){return h.get(`${y}/quote`).then(e=>e.data)}function re(e){return h.post(`${y}/subscription`,e).then(t=>t.data)}function C(e="Muscles",t=1,s=12){return h.get(`${y}/filters?filter=${encodeURIComponent(e)}&page=${t}&limit=${s}`).then(i=>O(i))}const _=Object.freeze({hidden:"visually-hidden"}),v=e=>{e==null||e.classList.remove(_.hidden)},p=e=>{e==null||e.classList.add(_.hidden)};function G({container:e,data:t,onUpdate:s}){if(!e)return;const{perPage:i,totalPages:o}=t;if(o<2){p(e);return}const r=(c,m)=>{const l=`<svg width="7" height=12>
      ...
      </li>`).join("")}function A(e,t){const s=e.querySelector(".categories-list");s&&(s.innerHTML=ce(t))}function ne(){const e=document.querySelector(".categories-container");e.querySelector(".categories-list").addEventListener("click",t=>{const s=t.target.closest(".categories-card-item");if(!s)return;const i=s.dataset.name;n.set("category",i),n.remove("keyword"),p(e),fe(),K()})}async function N(e=1){const t=n.get("filter"),s=document.querySelector(".categories-container");if(!s)return;v(s);const i=await C(t,e);A(s,i.results);const o=document.querySelector(".categories.tui-pagination");o&&G({container:o,data:i,onUpdate:async r=>{const a=await C(t,r);A(s,a.results)}})}const F=document.querySelector(".filter_panel"),le='<h2 class="exercises-title">Exercises</h2>',de=`
